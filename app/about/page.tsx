      ...
      <main className="max-w-2xl">
        ...
        <div className="border border-border p-4 sm:p-6 bg-card mb-6">
          ...
          <p className="leading-relaxed mb-4">
            This is <strong>the html blog</strong> &mdash; a blog about the web, written with
            the aesthetic sensibility of the web circa 1997. We believe in semantic markup,
            blue underlined links, and the radical idea that content is more important than
            presentation.
          </p>
          <p className="leading-relaxed mb-4">
            Here we write about web history, HTML nostalgia, the craft of building for the
            browser, and the enduring beauty of simple documents linked together with
            hypertext.
          </p>
          <p className="leading-relaxed">
            Every post on this site could be read with CSS disabled and still make perfect
            sense. We consider this a feature.
          </p>
        </div>
...
Dislikes: pop-ups, autoplaying video,
        ...
        <div className="border border-border p-4 sm:p-6 bg-card mb-6">
          ...
          <ul className="list-disc pl-6 leading-relaxed flex flex-col gap-1">
            ...
            <li>No JavaScript frameworks were harmed in the reading of these posts*</li>
          </ul>
        ...
        <div className="border border-border p-4 sm:p-6 bg-card">
          ...
          <ul className="flex flex-col gap-2 pl-6 list-disc">
            <li>
              <a href="https://developer.mozilla.org" className="text-primary underline hover:text-foreground" target="_blank" rel="noopener noreferrer">
                MDN Web Docs
              </a>
              {" — the best reference for web technologies"}
            </li>
            <li>
              <a href="https://web.archive.org" className="text-primary underline hover:text-foreground" target="_blank" rel="noopener noreferrer">
                The Wayback Machine
              </a>
              {" — preserving the web's history"}
            </li>
            <li>
              <a href="https://indieweb.org" className="text-primary underline hover:text-foreground" target="_blank" rel="noopener noreferrer">
                IndieWeb
              </a>
              {" — people-focused alternative to the corporate web"}
            </li>
            <li>
              <a href="https://motherfuckingwebsite.com" className="text-primary underline hover:text-foreground" target="_blank" rel="noopener noreferrer">
